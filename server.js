            ...
            const spawn = (() => {
                ...
                return (socket, name) => {
                    ...
                    let body = new Entity(loc);
                        body.protect();
                        body.define(Class.shrapnel); // Start as a basic tank
            ...
            const broadcast = (() => {
                ...
                const getminimap = (() => {
                  ...
                  o.ondeath = () => {
                    ...
                    i.color = 3;
                    sancount -= 1;
                    sockets.broadcast("The top left sanctuary has been destroyed! " + sancount + " Sanctuaries Left.");
                    util.log("[INFO] The Team Has Lost The Top Left Sanctuary. " + sancount + " Sanctuaries Left.");
                    i.ondeath = () => {
                      let e = new Entity(loc);
                      e.define(Class.sanctuary);
                      e.team = -1;
                      ...
                      e.color = 10;
                      sancount += 1;
                      sockets.broadcast("The top left sanctuary has been revived! " + sancount + " Sanctuaries Left.");
                      util.log("[INFO] The Team Has Revived The Top Left Sanctuary. " + sancount + " Sanctuaries Left.");
                      e.ondeath = o.ondeath
                      o = e;
                      };
                    };
                  ...
                  o.ondeath = () => {
                    ...
                    i.color = 3;
                    sancount -= 1;
                    sockets.broadcast("The up left down sanctuary has been destroyed! " + sancount + " Sanctuaries Left.");
                    util.log("[INFO] The Team Has Lost The Up Left Down Sanctuary. " + sancount + " Sanctuaries Left.");
                    i.ondeath = () => {
                      let e = new Entity(loc);
                      e.define(Class.sanctuary);
                      e.team = -1;
        ...
        return census => {
            if (timer > 10 && ran.dice(20 - timer)) {
                ...
                let elites1 = [Class.elite_gunner, /*Class.elite_destroyer,*/ Class.elite_sprayer, Class.elite_battleship],
                    ...
                    celestials1 = [Class.paladin, Class.freyja, Class.zaphkiel, Class.theia, Class.nyx, Class.athena, Class.alviss, Class.tyr, Class.fiolnir, Class.blaze],
                ...
                switch (wave) {
                    case 1: 
                        ...
                        break;
                    case 2: 
                        choice = [[ran.choose(elites1), ran.choose(elites2)], 2, 'a', ran.choose(rooms)]; 
                        sockets.broadcast('Wave Contenders: 2 Elite Crashers');
                        break;
                    case 3: 
                        choice = [[ran.choose(elites1), ran.choose(elites2), ran.choose(elites3)], 3, 'a', ran.choose(rooms)]; 
                        sockets.broadcast('Wave Contenders: 3 Elite Crashers');
                        break;
                    case 4: 
                        choice = [[ran.choose(elites1), ran.choose(elites2), ran.choose(elites3), ran.choose(elites4)], 4, 'a', ran.choose(rooms)]; 
                        sockets.broadcast('Wave Contenders: 4 Elite Crashers');
                        break;
                    case 5: 
                        choice = [[ran.choose(elites1), Class.ek1], 4, 'a', ran.choose(rooms)];
                        sockets.broadcast('Wave Contenders: ? Elite Crashers and ? EK1');
                        break;
                    case 6: 
                        choice = [[ran.choose(elites1), ran.choose(strange1)], 4, 'a', ran.choose(rooms)];
                        sockets.broadcast('Wave Contenders: ? Elite Crashers and ? Strange Bosses');
                        break;
                    case 7: 
                        choice = [[ran.choose(elites1), Class.ek2], 3, 'castle', ran.choose(rooms)];
                        sockets.broadcast('Wave Contenders: ? Elite Crashers and ? EK2');
                        break;
                    case 8: 
                        choice = [[ran.choose(strange1), ran.choose(strange2), ran.choose(strange3)], 3, 'castle', ran.choose(rooms)]; 
                        sockets.broadcast("Wave Contenders: 3 Strange Bosses");
                        break;
                    case 9: 
                        choice = [[ran.choose(strange1), ran.choose(strange2), ran.choose(strange3), ran.choose(strange4)], 4, 'castle', ran.choose(rooms)]; 
                        sockets.broadcast("Wave Contenders: 4 Strange Bosses");
                        break;
                    case 10: 
                        choice = [[ran.choose(strange1), Class.ek2], 3, 'castle', ran.choose(rooms)]; 
                    ...
                    case 23:
                        ...
                        break;
                    case 24:
                        choice = [[ran.choose(celestials1), ran.choose(elites1)], 3, 'castle', ran.choose(rooms)];
                        sockets.broadcast('Wave Contenders: ? Celestials and ? Elite Crashers');
                        break;
                    case 25:
                        choice = [[ran.choose(celestials1), ran.choose(strange1)], 3, 'castle', ran.choose(rooms)];
                        sockets.broadcast('Wave Contenders: ? Celestials and ? Strange Bosses');
                        break;
                    case 26:
                        choice = [[ran.choose(celestials1), Class.eq1], 3, 'castle', ran.choose(rooms)];
                        sockets.broadcast('Wave Contenders: ? Celestials and ? EQ1');
                        break;
                    case 27:
                        choice = [[ran.choose(celestials1), ran.choose(elites1), ran.choose(strange1)], 4, 'castle', ran.choose(rooms)];
                        sockets.broadcast('Wave Contenders: ? Celestials, ? Elite Crashers and ? Strange Bosses');
                        break;
                    case 28:
                        choice = [[ran.choose(celestials1), ran.choose(celestials2)], 2, 'castle', ran.choose(rooms)];
                        sockets.broadcast('Wave Contenders: 2 Celestials');
                        break;
                    case 29:
                        choice = [[ran.choose(celestials1), ran.choose(celestials2), ran.choose(elites1), ran.choose(elites2)], 3, 'castle', ran.choose(rooms)];
                        sockets.broadcast('Wave Contenders: ? Celestials and ? Elite Crashers');
                        break;
                    case 30:
