      ...
      if (timer > 100 && ran.dice(200 - timer)) {
        ...
        switch (wave) {
          ...
          case 16:
            ...
            sockets.broadcast(
              "The woomy celestials are entered the arrasicoi kingdom!"
            );
            break;
          case 17:
            choice = [[Class.nyx], 1, "castle", "norm"];
            sockets.broadcast(
              "The new final celestial is entered to the game."
            );
            break;
          case 18:
          ...
          case 20:
            ...
            sockets.broadcast(
              "We Believe in EK-X. Now whats on the other side?"
            );
            break;
          case 21:
          ...
          case 23:
            ...
            sockets.broadcast(
              "The SK-X is leveling up as the realms are ripping apart!"
            );
            break;
          case 24:
            choice = [[Class.tyr], 1, "castle", "norm"];
            sockets.broadcast(
              "The darkness arrived as the realms are ripped apart!"
            );
            break;
          case 25:
...
bot.on("ready", () => {
  ...
  bot.user.setActivity("arrasicoi!", {
    type: "PLAYING",
    url: "https://arrasicoi2.glitch.me/"
  });
