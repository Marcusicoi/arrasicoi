        ...
        return () => {
            ...
            spawnBosses(census);
                ...
                if (bots.length < c.BOTS) {
                    ...
                    o.color = 17;
                    o.define(Class.bot);
                  let arrayOfClasses = [Class.sniprifle, Class.lazer, Class.pentaseer, Class.pentaseer,
                                        Class.machinegunner, Class.pentaseer, Class.penta, Class.octo,
    ...
    let makefood = (() => {
        ...
        function getFoodClass(level) {
            ...
            switch (level) {
                ...
                case 5: a = Class.hugePentagon, Class.hugeHexagon; break;
