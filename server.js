...
const levelers = [
  ...
  48, 50, 52, 54, 56, 58, 60, 62, 64, 67, 70, 72, 75,
];
class Skill {
  ...
  define(set) {
    ...
    if (set.SEND_MESSAGE != null) {
      this.settings.sendMessage =
        set.SEND_MESSAGE === "" ? undefined : set.SEND_MESSAGE;
    }
    ...
    connect: (() => {
          ...
          case "k":
            {
              ...
              if (m.length === 1) {
                let key = m[0];
                socket.key = key;
                util.log("[INFO] A sockets was verified with the token: ");
                util.log(key);
              }
          ...
          case "s":
            {
              ...
              if (name === "") {
                ...
                (name === "", socket.key === process.env.DeveloperToken)
              ) {
                return sockets.broadcast(
                  "Unamed Player The Developer" +
                    (needsRoom ? " has rejoined" : " has joined") +
                    " the game!!!!! Players: " +
                    players.length +
                    "!"
      ...
      const spawn = (() => {
        ...
        return (socket, name) => {
          ...
          body.sendMessage(
            "You have spawned! Remember to subscibe Marcusicoi!"
          );
          /*
          ...
          if (room.sanM)
            for (let loc of room.sanM) {
              ...
              o.ondeath = () => {
                ...
                sancount -= 1;
                sockets.broadcast(
                  "The middle sanctuary has been destroyed! " +
                    sancount +
                    " Sanctuaries Left."
                );
                util.log(
                  "[INFO] The Team Has Lost The Middle Sanctuary. " +
                    sancount +
                    " Sanctuaries Left."
                );
                i.ondeath = () => {
                  ...
                  sancount += 1;
                  sockets.broadcast(
                    "The middle sanctuary has been revived! " +
                      sancount +
                      " Sanctuaries Left."
                  );
                  util.log(
                    "[INFO] The Team Has Revived The Middle Sanctuary. " +
                      sancount +
                      " Sanctuaries Left."
                  );
                  e.ondeath = o.ondeath;
          ...
          if (room.saUL)
            for (let loc of room.saUL) {
              ...
              o.ondeath = () => {
                ...
                sancount -= 1;
                sockets.broadcast(
                  "The top left sanctuary has been destroyed! " +
                    sancount +
                    " Sanctuaries Left."
                );
                util.log(
                  "[INFO] The Team Has Lost The Top Left Sanctuary. " +
                    sancount +
                    " Sanctuaries Left."
                );
                i.ondeath = () => {
                  ...
                  sancount += 1;
                  sockets.broadcast(
                    "The top left sanctuary has been revived! " +
                      sancount +
                      " Sanctuaries Left."
                  );
                  util.log(
                    "[INFO] The Team Has Revived The Top Left Sanctuary. " +
                      sancount +
                      " Sanctuaries Left."
                  );
                  e.ondeath = o.ondeath;
          ...
          if (room.sULD)
            for (let loc of room.sULD) {
              ...
              o.ondeath = () => {
                ...
                sancount -= 1;
                sockets.broadcast(
                  "The up left down sanctuary has been destroyed! " +
                    sancount +
                    " Sanctuaries Left."
                );
                util.log(
                  "[INFO] The Team Has Lost The Up Left Down Sanctuary. " +
                    sancount +
                    " Sanctuaries Left."
                );
                i.ondeath = () => {
                  ...
                  sancount += 1;
                  sockets.broadcast(
                    "The up left down sanctuary has been revived! " +
                      sancount +
                      " Sanctuaries Left."
                  );
                  util.log(
                    "[INFO] The Team Has Revived The Up Left Down Sanctuary. " +
                      sancount +
                      " Sanctuaries Left."
                  );
                  e.ondeath = o.ondeath;
          ...
          if (room.saUR)
            for (let loc of room.saUR) {
              ...
              o.ondeath = () => {
                ...
                sancount -= 1;
                sockets.broadcast(
                  "The top right sanctuary has been destroyed! " +
                    sancount +
                    " Sanctuaries Left."
                );
                util.log(
                  "[INFO] The Team Has Lost The Top Right Sanctuary. " +
                    sancount +
                    " Sanctuaries Left."
                );
                i.ondeath = () => {
                  ...
                  sancount += 1;
                  sockets.broadcast(
                    "The top right sanctuary has been revived! " +
                      sancount +
                      " Sanctuaries Left."
                  );
                  util.log(
                    "[INFO] The Team Has Revived The Top Right Sanctuary. " +
                      sancount +
                      " Sanctuaries Left."
                  );
                  e.ondeath = o.ondeath;
          ...
          if (room.sURD)
            for (let loc of room.sURD) {
              ...
              o.ondeath = () => {
                ...
                sancount -= 1;
                sockets.broadcast(
                  "The top right down sanctuary has been destroyed! " +
                    sancount +
                    " Sanctuaries Left."
                );
                util.log(
                  "[INFO] The Team Has Lost The Top Right Down Sanctuary. " +
                    sancount +
                    " Sanctuaries Left."
                );
                i.ondeath = () => {
                  ...
                  sancount += 1;
                  sockets.broadcast(
                    "The top right down sanctuary has been revived! " +
                      sancount +
                      " Sanctuaries Left."
                  );
                  util.log(
                    "[INFO] The Team Has Revived The Top Right Down Sanctuary. " +
                      sancount +
                      " Sanctuaries Left."
                  );
                  e.ondeath = o.ondeath;
          ...
          if (room.saDL)
            for (let loc of room.saDL) {
              ...
              o.ondeath = () => {
                ...
                sancount -= 1;
                sockets.broadcast(
                  "The down left sanctuary has been destroyed! " +
                    sancount +
                    " Sanctuaries Left."
                );
                util.log(
                  "[INFO] The Team Has Lost The Down Left Sanctuary. " +
                    sancount +
                    " Sanctuaries Left."
                );
                i.ondeath = () => {
                  ...
                  sancount += 1;
                  sockets.broadcast(
                    "The down left sanctuary has been revived! " +
                      sancount +
                      " Sanctuaries Left."
                  );
                  util.log(
                    "[INFO] The Team Has Revived The Down Left Sanctuary. " +
                      sancount +
                      " Sanctuaries Left."
                  );
                  e.ondeath = o.ondeath;
          ...
          if (room.sDLU)
            for (let loc of room.sDLU) {
              ...
              o.ondeath = () => {
                ...
                sancount -= 1;
                sockets.broadcast(
                  "The down left up sanctuary has been destroyed! " +
                    sancount +
                    " Sanctuaries Left."
                );
                util.log(
                  "[INFO] The Team Has Lost The Down Left Up Sanctuary. " +
                    sancount +
                    " Sanctuaries Left."
                );
                i.ondeath = () => {
                  ...
                  sancount += 1;
                  sockets.broadcast(
                    "The down left up sanctuary has been revived! " +
                      sancount +
                      " Sanctuaries Left."
                  );
                  util.log(
                    "[INFO] The Team Has Revived The Down Left Up Sanctuary. " +
                      sancount +
                      " Sanctuaries Left."
                  );
                  e.ondeath = o.ondeath;
          ...
          if (room.saDR)
            for (let loc of room.saDR) {
              ...
              o.ondeath = () => {
                ...
                sancount -= 1;
                sockets.broadcast(
                  "The down right sanctuary has been destroyed! " +
                    sancount +
                    " Sanctuaries Left."
                );
                util.log(
                  "[INFO] The Team Has Lost The Down Right Sanctuary. " +
                    sancount +
                    " Sanctuaries Left."
                );
                i.ondeath = () => {
                  ...
                  sancount += 1;
                  sockets.broadcast(
                    "The down right sanctuary has been revived! " +
                      sancount +
                      " Sanctuaries Left."
                  );
                  util.log(
                    "[INFO] The Team Has Revived The Down Right Sanctuary. " +
                      sancount +
                      " Sanctuaries Left."
                  );
                  e.ondeath = o.ondeath;
          ...
          if (room.sDRU)
            for (let loc of room.sDRU) {
              ...
              o.ondeath = () => {
                ...
                sancount -= 1;
                sockets.broadcast(
                  "The down right up sanctuary has been destroyed! " +
                    sancount +
                    " Sanctuaries Left."
                );
                util.log(
                  "[INFO] The Team Has Lost The Down Right Up Sanctuary. " +
                    sancount +
                    " Sanctuaries Left."
                );
                i.ondeath = () => {
                  ...
                  sancount += 1;
                  sockets.broadcast(
                    "The down right up sanctuary has been revived! " +
                      sancount +
                      " Sanctuaries Left."
                  );
                  util.log(
                    "[INFO] The Team Has Revived The Down Right Up Sanctuary. " +
                      sancount +
                      " Sanctuaries Left."
                  );
                  e.ondeath = o.ondeath;
    ...
    entities.forEach(function (element) {
      ...
      if (element.freezed && element.type == "tank") {
        ...
        if (
          ...
          element.freezedBy.skill != undefined
        ) {
          element.freezedBy.skill.score += Math.ceil(
            util.getJackpot(element.freezedBy.skill.score)
          );
          element.freezedBy.sendMessage(
            "You killed " + element.name + " with freeze."
          );
          element.sendMessage(
            "You have been killed by " +
              element.freezedBy.name +
              " with freeze."
          );
        }
      }
...
var maintainloop = (() => {
  ...
  let makefood = (() => {
    ...
    function getFoodClass2(level) {
      ...
      switch (level) {
        case 0:
          a = ran.chooseChance([Class.egg, Class.gem, Class.jewel]);
          break;
        case 1:
          a = Class.gsqu;
          break;
      ...
      for (let i = Math.ceil(food.length / 100); i > 0; i--) {
        ...
        for (let j = 0; j < 6; j++) {
          ...
          let probabilities = c.FOOD,
            ...
            amount = foodAmount;
          if (room.isIn("nest", o)) {
            (probabilities = c.FOOD_NEST), (cens = censusNest);
            ...
            if (
              ran.chance(
                1 -
                  cens[o.foodLevel + 1] /
                    amount /
                    probabilities[o.foodLevel + 1]
              )
            ) {
              o.define(
                o.isGreenShape
                  ? getFoodClass2(o.foodLevel + 1)
                  : getFoodClass(o.foodLevel + 1)
              );
            }
          }
        }
...
let server = http.createServer((req, res) => {
  ...
  switch (pathname) {
    case "/":
      res.writeHead(200);
      res.end(
        `<!DOCTYPE html><h1>Arrasicoi</h1><button onclick="location.href = 'http://arras.io/#host=' + location.host">Open</button>`
      );
      break;
    case "/mockups.json":
...
bot.on("ready", () => {
  util.log("Bot ready!");
  bot.user.setActivity("arrasicoi!", {
    type: "PLAYING",
...
bot.on("messageCreate", (message) => {
  if (message.content === ">help") {
    const embed = {
      title: "Commands.",
      description:
        ">players = Sends Player's Name And ID" +
  ...
  if (message.content.startsWith(">broadcast")) {
    if (
      message.member.roles.cache.some((role) => role.name === "Beta Tester")
    ) {
      let args = message.content.substring(11);
      sockets.broadcast(args);
      message.channel.send(
        'Successfully Broadcasted "' + args + '" To The Game.'
      );
    } else {
      message.channel.send(
        'You need a role called "Beta Tester" To Execute The Command.'
      );
    }
  }
  ...
  if (message.content.startsWith(">define")) {
    ...
    if (
      ...
      message.channel.send(
        "You need to have the role named 'Beta Tester' To Execute the command."
      );
    }
  }
  ...
  if (message.content.startsWith(">restore all ")) {
    let error = false,
      command = parse(message.content),
      inputid = command[1],
      inputvalue = command[2];
    entities.forEach((element) => {
      if (
        message.member.roles.cache.some((role) => role.name === "BOTicoi DEV")
      ) {
  ...
  if (message.content.startsWith(">tile")) {
      ...
      h = ran.choose(["Ce", "Du", "Te", "Qr", "Qn", "Se", "Si", "Ot", "Ne"]),
      ...
      h2 = ran.choose(["Ce", "Du", "Te", "Qr", "Qn", "Se", "Si", "Ot", "Ne"]),
      ...
      h3 = ran.choose(["Ce", "Du", "Te", "Qr", "Qn", "Se", "Si", "Ot", "Ne"]),
