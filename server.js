        ...
        connect: (() => {
            ...
            const broadcast = (() => {
                ...
                const getminimap = (() => {
                  ...
                  o.ondeath = () => {
                    sancount -= 1;
                    sockets.broadcast("The top left down sanctuary has been destroyed! " + sancount + " Sanctuaries Left.");
                    util.log("[INFO] The Team Has Lost The Top Left Down Sanctuary. " + sancount + " Sanctuaries Left.");
                    };
                  };
                  if (room.saUR)
